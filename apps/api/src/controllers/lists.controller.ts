...
export async function create(req: Request, res: Response) {
  try {
    const { boardId } = req.params
    const list = await createList(boardId, req.user!.id, req.body as CreateListInput)
...
export async function update(req: Request, res: Response) {
  try {
    const { id } = req.params
    const list = await updateList(id, req.user!.id, req.body as UpdateListInput)
...
export async function reorder(req: Request, res: Response) {
  try {
    const { boardId } = req.params
    const lists = await reorderLists(boardId, req.user!.id, req.body as ReorderListsInput)
